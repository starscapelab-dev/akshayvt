export const aboutContent = {
  hero: {
    eyebrow: "Hello, hi · നമസ്കാരം · مرحبا",
    title: "A developer you can actually rely on.",
    intro:
  ...
  stats: [
    ...
    { value: "100%", label: "Direct client communication" },
  ...
  skills: [
    {
      title: "Frontend",
      icon: "frontend",
      items: ["React 18", "Next.js 14+", "TypeScript", "Tailwind CSS", "Framer Motion", "Astro · Svelte"],
    },
    {
      title: "Backend",
      icon: "backend",
      items: ["Node.js · Express", "Next.js API routes", "PHP · Laravel", "PostgreSQL", "MongoDB", "Redis"],
    },
    {
      title: "CMS & Commerce",
      icon: "cms",
      items: ["Sanity · Contentful", "WordPress · ACF", "Shopify · Liquid", "Strapi · Payload", "Stripe · Razorpay"],
    },
    {
      title: "Infra & Performance",
      icon: "infra",
      items: ["Vercel · Cloudflare", "AWS Amplify", "Docker · GitHub Actions", "Lighthouse · CWV", "Sentry · PostHog"],
    },
  ],
  ...
  timeline: [
    ...
    {
      year: "2021",
      subtitle: "The React years",
      title: "Switched to React + Next.js full-time",
      description:
        "Joined an early-stage startup as the second engineer. Built the marketing site, the dashboard, and most of the billing flow.",
    },
    {
      year: "2022",
      subtitle: "First UAE client",
      title: "Shipped my first project for a Dubai client",
      description:
    ...
    {
      year: "2023",
      subtitle: "Went freelance",
      title: "Left full-time work to focus on independent clients",
      description:
    ...
    {
      year: "2024",
      subtitle: "Cross-continent",
      title: "Shipped projects across UAE, India, Australia, Qatar",
      description:
  ...
  pullQuote: {
    quote: "The best website is the one your client actually remembers to update. Everything else is just engineering.",
    source: "— A. on Twitter, 2024",
  },
